...
1. 每人頭兩張一定要估，未估完唔可以停牌。
2. 輪到你哋時，面對面傾掂，先輸入 0 到 10。
3. 由第 3 張開始，見到新題可以「要牌」或者「停牌」。停牌係拒絕張題，張題會交畀另一隊。
4. 兩隊都停牌，或者題目用完，就揭曉。
5. 實際總分超過 21 算爆。未爆嘅一隊，分數高啲（接近 21）就贏。兩隊都爆就當平手。
